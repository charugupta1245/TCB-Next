      ...
      <footer className="bg-gray-900">
        <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="flex justify-center text-gray-100 sm:justify-start">
                {/* <img src="logo.webp" className="h-7 w-7"></img> */}
                <h2 className="font-bold text-2xl ml-4">The Capital Box</h2>
                {/* <svg
                  className="h-8"
                  viewBox="0 0 118 24"
                  fill="none"
              ...
              <p className="max-w-md mx-auto mt-6 leading-relaxed text-center text-gray-400 sm:max-w-xs sm:mx-0 sm:text-left">
                We give our customers an unmatched personalized solutions as per
                their needs.
              </p>
                  ...
                  <ul className="space-y-4 text-sm">
                    <li>
                      <a
                        ...
                        href="/"
                      >
                        Opening Days:<br></br> Monday – Friday : 10am to 6 pm
                    ...
                    <li>
                      <a
                        ...
                        href="/"
                      >
                        Vacations:<br></br> All Sunday Days All Official
                        Holidays{" "}
                      </a>
                    </li>
                  </ul>
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  ...
                  <li className="flex items-start justify-center gap-1.5 sm:justify-start">
                    ...
                    <address className="-mt-0.5 not-italic text-white">
                      South City 1, Gurugram, Haryana - 122001{" "}
                    </address>
                  </li>
                </ul>
              </div>
          ...
          <div className="pt-6 mt-12 border-t border-gray-800">
            <div className="text-center sm:flex sm:justify-between sm:text-left">
              <p className="text-sm text-gray-400">
                ...
                <a
                  className="inline-block text-gray-500 underline transition hover:text-gray-500/75"
                  href="/"
                >
                  Terms & Conditions
                </a>
