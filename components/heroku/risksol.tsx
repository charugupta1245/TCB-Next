...
export default function Riskherokusec() {
  ...
  return (
    ...
    >
      <div className="w-full md:w-1/2 p-10 flex flex-col justify-center">
        <h1 className="text-5xl font-bold mb-4">Risk Management</h1>
      ...
      <div className="w-full md:w-1/2">
        <Image
          src="https://plus.unsplash.com/premium_photo-1661281307045-edb4d54e313f?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Replace with actual image path
