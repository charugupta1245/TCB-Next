...
export default function Retireherokusec() {
  ...
  return (
    ...
    >
      <div className="w-full md:w-1/2 p-10 flex flex-col justify-center">
        <h1 className="text-5xl font-bold mb-4">Retirement Solutions</h1>
      ...
      <div className="w-full md:w-1/2">
        <Image
          src="https://plus.unsplash.com/premium_photo-1675368994978-0c7c12d7d4bd?q=80&w=2072&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Replace with actual image path
